...
import { getPublicClient, getWalletClient, getEnvWalletClient, getPrivateKey } from './clients.js';
...
/**
 * Transfer ETH to an address using the environment private key
 * @param toAddressOrEns Recipient address or ENS name
 * @param amount Amount to send in ETH
 * @param network Network name or chain ID
 * @returns Transaction hash
 */
export async function transferETHWithEnvKey(
  toAddressOrEns: string,
  amount: string, // in ether
  network = 'ethereum'
): Promise<Hash> {
  ...
  // Get wallet client with environment private key
...
/**
 * Transfer ERC20 tokens to an address using the environment private key
 * @param tokenAddressOrEns Token contract address or ENS name
 * @param toAddressOrEns Recipient address or ENS name
 * @param amount Amount to send (in token units)
 * @param network Network name or chain ID
 * @returns Transaction details
 */
export async function transferERC20WithEnvKey(
  tokenAddressOrEns: string,
  toAddressOrEns: string,
  amount: string,
  network: string = 'ethereum'
  ...
  // Create wallet client for sending the transaction
  const walletClient = getEnvWalletClient(network);
...
/**
 * Approve ERC20 token spending using the environment private key
 * @param tokenAddressOrEns Token contract address or ENS name
 * @param spenderAddressOrEns Spender address or ENS name
 * @param amount Amount to approve (in token units)
 * @param network Network name or chain ID
 * @returns Transaction details
 */
export async function approveERC20WithEnvKey(
  tokenAddressOrEns: string,
  spenderAddressOrEns: string,
  amount: string,
  network: string = 'ethereum'
...
/**
 * Transfer an NFT (ERC721) to an address using the environment private key
 * @param tokenAddressOrEns NFT contract address or ENS name
 * @param toAddressOrEns Recipient address or ENS name
 * @param tokenId Token ID to transfer
 * @param network Network name or chain ID
 * @returns Transaction details
 */
export async function transferERC721WithEnvKey(
  tokenAddressOrEns: string,
  toAddressOrEns: string,
  tokenId: bigint,
  network: string = 'ethereum'
...
/**
 * Transfer ERC1155 tokens to an address using the environment private key
 * @param tokenAddressOrEns Token contract address or ENS name
 * @param toAddressOrEns Recipient address or ENS name
 * @param tokenId Token ID to transfer
 * @param amount Amount to transfer
 ...
 * @returns Transaction details
 */
export async function transferERC1155WithEnvKey(
  tokenAddressOrEns: string,
  toAddressOrEns: string,
  tokenId: bigint,
  amount: string,
