...
// File: @openzeppelin/contracts@v4.9.3/utils/math/SafeMath.sol
...
// File: mainnet/0xad53ed3fee57160f026189eb91e73e9317fa92f1/contracts/IUniswapV2Router01.sol
...
// File: mainnet/0xad53ed3fee57160f026189eb91e73e9317fa92f1/contracts/IUniswapV2Router02.sol
...
// File: mainnet/0xad53ed3fee57160f026189eb91e73e9317fa92f1/contracts/IUniswapV2Factory.sol
...
// File: mainnet/0xad53ed3fee57160f026189eb91e73e9317fa92f1/contracts/IUniswapV2Pair.sol
...
// File: mainnet/0xad53ed3fee57160f026189eb91e73e9317fa92f1/contracts/ZkTAO.sol


pragma solidity ^0.8.0;


contract MCPERC20 is Ownable, ERC20 {
    ...
    constructor(
        ...
        maxHolder = _maxSupply / 400;
        swapAtAmount = _maxSupply / 1400;

        tradingEnabled = false;
        buyFee = _initialBuyFee;
        sellFee = _initialSellFee;

        if (_developmentFund == address(0)) {
            developmentFund = _msgSender();
        }

        IUniswapV2Router02 _router = IUniswapV2Router02(_dexRouter);
    ...
    function _transfer(
        ...
        if (canSwap && !inSwap && swapAndLiquifyEnabled) {
            inSwap = true;
    ...
    function swapTokensForETH(uint256 tokenAmount) private {
        ...
        uint256 developFundValue = address(this).balance;
        payable(developmentFund).call{value: developFundValue}("");
    }

    function setExcludeFromFee(address _address, bool _status)
        external
        onlyOwner
    {
